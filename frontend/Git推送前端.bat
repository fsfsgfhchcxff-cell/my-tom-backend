...
echo [3/6] 创建提交...
git commit -m "🎨 Initial commit: 汤姆猫学习版前端 (React + Tailwind CSS + 三丽鸥风格)"
if errorlevel 1 (
...
echo ================================================
echo.
echo 💡 请在 GitHub 创建一个新仓库，例如：tom-learning-frontend
echo    创建时不要勾选 "Add a README file"
echo.
echo 📝 示例地址：
echo    https://github.com/你的用户名/tom-learning-frontend.git
echo.
